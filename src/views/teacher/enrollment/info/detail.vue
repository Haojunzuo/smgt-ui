...
<!--          {{studentInfo.nickName}}-->
        ...
        <el-descriptions-item>
          ...
          <el-input v-model="studentInfo.identity"></el-input>
...
<!--          {{studentInfo.country}}-->
      ...
      <el-descriptions class="margin-top" title="在校信息" :column="3"  border style="margin-top: 20px">
        <el-descriptions-item>
          ...
          <el-select v-model="studentInfo.collegeNo" class="add-nation-input" >
        ...
        <el-descriptions-item>
          ...
          <el-select v-model="studentInfo.classNo"  class="add-nation-input" >
        ...
        <el-descriptions-item>
          ...
          <el-select v-model="studentInfo.major"  class="add-nation-input" >
        ...
        <el-descriptions-item>
          ...
          <el-select v-model="studentInfo.planType"  class="add-nation-input" >
        ...
        <el-descriptions-item>
          ...
          <el-select v-model="studentInfo.stuType"  class="add-nation-input" >
        ...
        <el-descriptions-item>
          ...
          <el-select v-model="studentInfo.length"  class="add-nation-input" >
        ...
        <el-descriptions-item>
          ...
          <el-select v-model="studentInfo.status"  class="add-nation-input" >
        ...
        <el-descriptions-item>
          ...
          <el-select v-model="studentInfo.schoolStatus"  class="add-nation-input" >
