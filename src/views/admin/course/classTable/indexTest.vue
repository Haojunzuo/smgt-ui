<template>
  <div>
    ...
    <el-table :data="timeData" stripe style="width: 100%">
      <el-table-column width="100" label="周" fixed="left" prop="label" align="center"></el-table-column>

      <el-table-column label="上午" align="center">
        <el-table-column width="118" v-for="(v,i) in titleData" :key="i" v-if="v.label==='上午'" align="center">
...
<!--              <div v-else>-->
<!--                <el-input size="mini" placeholder="科目" suffix-icon="el-icon-date" v-model="scope.row[sbjectKey[i]]"/>-->
<!--                <el-select clearable v-model="scope.row[teacherKey[i]]" size="mini" placeholder="任课老师">-->
<!--                  <el-option-->
